...
if(!userBean.authenticated()){
    response.sendRedirect("../login.jsp?url=lov/LicenseLOV.jsp?clicense=" + request.getParameter("clicense") );
}
%>
<%-------------------------%>
<%
...
<script language="JavaScript" type="text/JavaScript">
	...
	function changText(s,f) {
		document.searchlov.clicense.value=hex2thai(s);
		if (f != 'null') {
...
<body onLoad="changText('<%= request.getParameter("clicense") %>','<%= request.getParameter("first") %>')">
          ...
          <td bgcolor="#F6F6EB" align="left" valign="top"> <table width="100%" height="400" border="0" cellpadding="0" cellspacing="10" >
              <tr> 
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="2">
                    <tr> 
                      <td colspan="3" class="pagetitle">ทะเบียน</td>
                    </tr>
                    <tr> 
					 ...
					 <form action="?" method="post" name="searchlov" id="searchlov">
					     <input name="clicense" type="hidden" class="text" id="clicense" value="<%= ShowData.CheckNull(request.getParameter ( "clicense" )) %>" >
                ...
                <td align="center"><div scrollleft="0" scrolltop="0" align="left" style="border: 1px solid;border-color:#D8D8C4;OVERFLOW: scroll; WIDTH: 100%; HEIGHT: 350;background-color:#F6F6EB;"> 
					...
					if(laction != null && laction.equals("search")){
						try{
							...
							cust.setLicense(request.getParameter("clicense"));
