        ...
        for(j=0;j<number.length+1;j++)
        {
             if ((ch == j)||(ch == "."))
             {
                  ...
                  if(j==10)
                  {
                    ...
                    value=0;
                    valueObj.value = "0.00";
                    alert('ต้องเป็นเลขจำนวนเต็มหรือทศนิยมเท่านั้น');
                  }
              }
              if(isOK == false) break;
         }
        ...
        for(j=0;j<number.length+1;j++)
        {
             if (ch == j)
             {
                  ...
                  if(j==10)
                  {
                    ...
                    value=0;
                    valueObj.value = "0";
                    alert('ต้องเป็นเลขจำนวนเต็มเท่านั้น');
                  }
              }
              if(isOK == false) break;
         }
...
function confirmDelete(inputedData) {
...
function MM_validateForm() { //v4.0
  ...
  for (i=0; i<(args.length-2); i+=3) { 
  	...
  	show=args[i+1];
//  	alert(i+"\ttest = "+test+"\tname = "+val.name+"\tshow = "+show+"\tval = "+val.value);
//  	alert("val = "+val);
    if (val) { 
    	nm=val.name; 
    	if ((val=val.value)!="") {
    	...
    	} else if (test.charAt(0) == 'R') errors += '- กรุณาใส่ข้อมูล '+show+'\n'; }
